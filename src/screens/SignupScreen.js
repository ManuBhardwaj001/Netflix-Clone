            ...
            <div className="signupScreen__bottom">
                ...
                <div className="signupScreen__recaptcha">
                    ...
                    <div className="recaptcha__disclosure">
                        <span>The information collected by Google reCAPTCHA is subject to the Google Privacy Policy and Terms of Service, and is used for providing, maintaining, and improving the reCAPTCHA service and for general security purposes (it is not used for personalised advertising by Google).</span>
                    </div>
                </div>
            </div>
        </form>
